// pages/AdminUsersPage.tsx - ИСПРАВЛЕННАЯ НАВИГАЦИЯ
        ...
        <IonCard className="rounded-xl overflow-hidden shadow-lg">
          <IonCardContent className="p-8 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center">
              <IonIcon icon={constructOutline} className="text-orange-600 dark:text-orange-400 text-4xl" />
            </div>
            ...
            <p className="text-[#475569] dark:text-gray-400 font-montserrat mb-6">
              Функционал управления пользователями будет доступен в ближайшее время
            </p>
            
            <IonChip className="bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300">

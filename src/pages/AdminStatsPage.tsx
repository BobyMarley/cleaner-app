// pages/AdminStatsPage.tsx - ИСПРАВЛЕННАЯ АВТОРИЗАЦИЯ
      ...
      <IonContent className="ion-padding">
        <IonCard className="rounded-xl overflow-hidden shadow-lg">
          <IonCardContent className="p-8 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-pink-100 dark:bg-pink-900/30 rounded-full flex items-center justify-center">
              <IonIcon icon={constructOutline} className="text-pink-600 dark:text-pink-400 text-4xl" />
            </div>
            ...
            <p className="text-[#475569] dark:text-gray-400 font-montserrat mb-6">
              Функционал статистики и аналитики будет доступен в ближайшее время
            </p>
            
            <IonChip className="bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300">

// pages/AdminOrdersPage.tsx - ИСПРАВЛЕННАЯ НАВИГАЦИЯ
        ...
        <IonCard className="rounded-xl overflow-hidden shadow-lg">
          <IonCardContent className="p-8 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center">
              <IonIcon icon={constructOutline} className="text-green-600 dark:text-green-400 text-4xl" />
            </div>
            ...
            <p className="text-[#475569] dark:text-gray-400 font-montserrat mb-6">
              Функционал управления заказами будет доступен в ближайшее время
            </p>
            
            <IonChip className="bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300">
